...
dir_datasets_prefix = '/curdir/' # '/curdir/'
...
def get_result(
    ...
    for env_no in list_env:
        ...
        # Save the model
        model_path = dir_datasets_prefix + 'datasets/best_model_' + str(var_trial) + '_' + str(var_env_no) + '_' + str(var_nhn) + '_' + str(var_lr) + '_' + str(var_struct_code) + '.pt'
...
if __name__=='__main__':
    ...
    num_iterations = 1000 ## should be (500 or 1000) for train on BEEF (extrapolation) or (5000/500 or 10000/1000) for train on individual env (intrapolation)
    #-----------change_1
    #
    dir_datasets = dir_datasets_prefix + 'datasets/'
